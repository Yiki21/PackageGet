...
use updater_managers::{
    ...
    FlatpakManager as DirectFlatpakManager, HomebrewManager as DirectHomebrewManager,
...
///
/// APT, DNF, Pacman, Zypper, Flatpak, and Homebrew are registered through their direct
